...
class OGController(object):
    ...
    def is_support_package(pkg):
        # openGauss server：openGauss-Server-7.0.0-RC3-openEuler20.03-x86_64.tar.gz
...
if __name__ == "__main__":
    og = OGController('/data/pkg/openGauss-Server-7.0.0-RC3-openEuler20.03-x86_64.tar.bz2')
    og.install()
    og.initdb()
    og.start(16666)
