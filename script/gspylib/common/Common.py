...
class DefaultValue():
    ...
    @staticmethod
    def register_ssh_agent(mpprcfile, logger="", shell_path=""):
        """
        ...
        DefaultValue.check_use_ssh_agent(cmd, bashrc_file, logger, shell_path=shell_path)
        if logger:
            logger.debug("ssh-add perform successfully.")

    @staticmethod
    def check_use_ssh_agent(cmd, mpprcfile, logger="", shell_path="", retry_imes=6):
        """
